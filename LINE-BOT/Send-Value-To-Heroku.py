...
def connectDevice():
	...
	r = requests.post("http://127.0.0.1:5001/LineBot", json={ 'connect' : serialName, \
 		         ...
 		         'battery' : [{ 'status' : [{ 'batteryHealth' : batteryHealth, 'batteryStatus' : batteryStatus, 'batteryCharge_Mode' : batteryCharge_Mode, 'batteryVolt' : str(batteryVolt), 'batteryTemp' : str(batteryTemp), 'batteryRemain_Percent' : str(batteryRemain_Percent)}]}, \
